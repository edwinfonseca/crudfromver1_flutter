...
import 'package:fromcrudbloc/src/utils/utils.dart' as utils;
...
class _ProductoPageState extends State<ProductoPage> {
  ...
  Widget build(BuildContext context) {
    prodcutosBloc = Provider.productosBloc(context);
  ...
  void _enviar() async {
    ...
    if (foto != null) {
      producto.fotoUrl = await prodcutosBloc.subirFoto(foto);
    }
    ...
    if (producto.id == null) {
      prodcutosBloc.agregarProducto(producto);
    } else {
      prodcutosBloc.editarProducto(producto);
    }
    /*setState(() {
      _guardar = false;
    });*/
